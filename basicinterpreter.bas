...
20 MODE7:VDU23,0,10,8;0;0;0;23,0,11,15;0;0;0;:PRINT:D=-1:DIM S% 255:L%=40:*FX11,0
...
REM Word-wrap
2060 DEFPROCp($S%):LOCALA%,Z%,C%,N%,T%:L%=40:N%=LEN$S%:A%=0:Z%=L%+1-POS:REPEATIFZ%>N%Z%=N%ELSEREPEATZ%=Z%-1:C%=S%?Z%:UNTILC%=32:IFZ%<A%Z%=A%+L%
