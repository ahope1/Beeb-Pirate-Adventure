...
300 IF IA(Z)<>R THEN320 ELSE GOSUB280:IFPOS+LEN(TP$)+3>40THENPRINT
310 PRINTTP$;".  ";
320 NEXT:PRINT
...
REM Process the actions
560 IP=0:PROCd2("560 FOR"):FORY=1TO4:K=INT((Y-1)/2)+6:ON Y GOTO570,580,570,580
570 AC=INT(CA(X,K)/150):PROCd4("AC="+STR$(AC)):GOTO590
580 AC=CA(X,K)-INT(CA(X,K)/150)*150:PROCd4("AC="+STR$(AC))
...
890 PRINT"I'M CARRYING:":K$="NOTHING":PROCd3("890 FOR"):FORZ=0TOIL:IFIA(Z)<>-1THEN910 ELSEGOSUB280:IFLEN(TP$)+POS>40PRINT
900 PRINTTP$;".",;:K$=""
910 NEXT:PROCd3("890 NEXT 910"):PRINTK$:GOTO960
...
970 PROCd4("NV(0)="+STR$(NV(0))):IF NV(0)<>0 THEN x=X:X=CL:NEXTX:X=x:PROCd("360 NEXT 970"):GOTO990
